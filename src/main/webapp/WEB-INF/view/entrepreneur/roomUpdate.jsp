...
<h2 style="text-align: center;">객실정보수정</h2>
  <form action="${pageContext.request.contextPath}/room/roomUpdatePro" method="post" enctype="multipart/form-data">
    <div class="mb-3 mt-3">
      <label>객실이름</label>
      <input type="text" class="form-control" id="subject" name="ro_name" value="${room.ro_name}">
    </div>
    <div class="mb-3">
      <label>가격</label>
      <input type="text" class="form-control" id="cal" name="ro_price" value="${room.ro_price}">
    </div>
    ...
    <select id="people" name="ro_count">
    	...
    	<label style=" margin-bottom: 10px;">객실기본정보&nbsp;&nbsp;&nbsp;</label><span id="byteInfo" style="display: inline;">0</span> /3900bytes
   		<textarea rows="10" cols="100" name="ro_info" onKeyUp="javascript:fnChkByte(this,'3900')">${room.ro_info}</textarea>
    </div>
    
    <label style=" margin-bottom: 10px;">객실사진등록&nbsp;&nbsp;&nbsp;</label>
    <textarea rows="10" cols="100" name="location">${pic}</textarea>
