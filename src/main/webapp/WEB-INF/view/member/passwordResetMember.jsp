...
<div class="signup_form_width">
		<div style="text-align : center;">
			<b class="large_text" style="color:#ffc107;">비밀번호 변경</b>
		</div>
	<form name="f" action="${pageContext.request.contextPath}/member/passwordResetMemberPro" method="post">
		<div class="row mt-5">
			  <label><span id="result">이메일</span></label>
			<div class="col-sm-8">
			  <input type="email" name="email" class="form-control form-control-lg" id="email" placeholder="GOING 아이디" required>
			</div>
			<div class="col-sm-4">
				<button type="button" id="email_btn" class="default_btn rounded" style="height: 48px;" onclick="emailChk()">아이디 확인</button>
			</div>
		</div>
