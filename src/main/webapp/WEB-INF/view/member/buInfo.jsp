	...
	<div class="default_width container-fluid">
		<div class="row">
			<div class="col-sm-2" id="memberinfo_left_nav">
				<a href="${pageContext.request.contextPath}/member/buInfo">
					내정보<br>
					<br>
				</a>
				<a href="${pageContext.request.contextPath}/member/buUpdateForm">
					정보수정<br>
					<br>
				</a>
			</div>
			<div class="col-sm-8">
				...
				<br>
				<div>
					<p class="memberInfo_defalut_btn rounded">이름</p>
					<p class="memberInfo_default_text">${mem.bu_name}</p>
				</div>

				<br>
				<br>
				<div>
					<p class="memberInfo_defalut_btn rounded">주소</p>
					<p class="memberInfo_default_text">${mem.bu_address}</p>
				</div>

				<br>
				<br>
				<div>
					<p class="memberInfo_defalut_btn rounded">전화번호</p>
					<p class="memberInfo_default_text">${mem.bu_tel }</p>
