...
// 		화면이 실행될때 함께 실행된다.
	...
	<div class="admin-box">
		...
		<div style="justify-content: center; margin-top: 25px;">
			<form action="<%=request.getContextPath()%>/admin/areaSales">
				<div class="row">
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<input class="admin-submit" type="submit" value="검색">
					</div>
				</div>
			</form>
			<div id="ColumnChart" style="width: 1200px; height: 600px;  margin-top:10px; margin-left:-125px;"></div>
		</div>
	</div>
</body>
</html>