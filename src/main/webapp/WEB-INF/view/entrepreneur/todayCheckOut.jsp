...
<h2 style="text-align: center; margin: 30px 0px;">오늘 체크아웃 목록</h2>

<div class="container col-sm-6" style="margin-top: 50px; float: left;">
  <h2 style="text-align: center;">퇴실 전</h2>
    ...
    <c:forEach var="nc" items="${notCheckOut}" varStatus="i">
      <tr>
        ...
        <td>${nc.checkout}</td>
     	<td>${nc.name}</td>
        <td>${nc.tel}</td>
        <td><input type="button" class="update" value="체크아웃"></td> <!-- id는 유니크 값이어야하는데 반복문에 의해 동일한 id가
...
<div class="container col-sm-6" style="margin-top: 50px; float: right;">
  <h2 style="text-align: center;">퇴실완료</h2>
  <table class="table table-hover" style="margin-top: 30px; text-align: center;">
    <thead>
      <tr>
      	<th>번호</th>
